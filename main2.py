...
aadarsh_image=face_recognition.load_image_file("Photos\Aadarsh.jpg")
aadarsh_encoding=face_recognition.face_encodings(aadarsh_image)[0]
...
known_face_encoding=[aadarsh_encoding,elon_encoding,dhoni_encoding,harsh_encoding]
known_face_names=["Aadarsh Ranjan","Elon Musk","MS Dhoni","Harsh Soni"]
